...
function CapGroup:new(groupName, airbaseId, logger, database, capConfig)
    ...
    local parsed = Spearhead.internal.Air.ParseCapGroupName(groupName)
    if parsed == nil then return nil end
    o.capZonesConfig = parsed.zonesConfig
    o.groupType = parsed.capGroupType
    ...
    o.Despawn = function(self)
        ...
        self:SetState(Spearhead.internal.Air.GroupState.UNSPAWNED)
    end
    ...
    o.OnGroupRTBInTen = function(self, groupName)
        if groupName == self.groupName then
            self:SetState(Spearhead.internal.Air.GroupState.RTBINTEN)
        end
    end
    ...
    o.OnGroupOnStation = function(self, groupName)
        if groupName == self.groupName then
            ...
            self:SetState(Spearhead.internal.Air.GroupState.ONSTATION)
        end
    end
