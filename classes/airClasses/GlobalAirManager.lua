...
do
    ...
    function GlobalAirManager.start(database, capConfig, stageConfig, casConfig)
        ...
        ---@return boolean
        InfoFunctions.IsBaseActiveWhenZoneIsActive = function(zoneName, activeZoneNumber)
...
Spearhead.internal.GlobalAirManager = GlobalAirManager
